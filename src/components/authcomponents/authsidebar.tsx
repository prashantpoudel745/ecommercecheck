...
const Authsidebar = () => {
  return (
    <div className="relative hidden flex-1 overflow-hidden bg-[linear-gradient(160deg,_#0f172a_0%,_#111827_48%,_#1e293b_100%)] px-10 py-12 text-slate-100 lg:flex lg:items-center lg:justify-center">
      ...
      <div className="relative max-w-xl">
        ...
        <h2 className="mt-6 text-4xl font-semibold tracking-tight text-white xl:text-5xl">
