...
import { fetchQuotations } from "@/services/sales.service";
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500">Manage all your sales quotations</p>
        </div>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              {loading ? (
                ...
                <tr><td colSpan={5} className="px-6 py-8 text-center text-slate-400">No quotations found.</td></tr>
              ) : (
                data.map((item: any) => (
